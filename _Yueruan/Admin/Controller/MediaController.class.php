...
class MediaController extends Controller {
	...
	public function save(){
		...
		$upload->maxSize = 16*1024*1024 ;//  设置附件上传大小
		$upload->exts = array('jpg', 'gif', 'png', 'jpeg', 'bmp', 'zip', 'rar', '7z', 'doc', 'ppt', 'xls', 'docx', 'pptx', 'xlsx', 'txt');//  设置附件上传类型
