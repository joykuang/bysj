...
//  this.formattedDate = dateFormat(this.data.date, 'fullDate');
  this.formattedDate = dateFormat(this.data.date, 'zhcnDate');	//TODO: 设置时间的格式化样式（via date.format.js #99）
...
ExperimentParticle.prototype.mouseOver = function() {
  ...
  domImage.src = '/500/images/trans.gif';
  var _this = this;
  ...
  srcTimeout = setTimeout(function() {
    ...
    domImage.src = '/500/data/images/'+_this.data.id+'.jpg';
  }, 50);
